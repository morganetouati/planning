...
elseif ($formtype == 'boutonsjournee') {
    $start_search = date("Y-m-d");
    $fin_search = date("Y-m-d");
}
else {
                    ...
                    <div id="formhoraire">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form id="horaire" role="form" action="valid-horaires.php" method="post">
                                    <input type="hidden" name="form_type" value="boutonsjournee"/>
                ...
                <div class="col-sm-6">
                    <table id="heure2" class="table table-hover">
                        ...
                        foreach ($reqs as $k => $v) {
                            ...
                            //echo '<td>' . Planning_ModelHelper::fix_time($v['total_semaine']) . '</td>';
                            //echo '<td>' . Planning_ModelHelper::fix_time($v['total_mois']) . '</td>';
                            //echo '<td>' . Planning_ModelHelper::fix_time($v['total_annee']) . '</td>';
                            echo '</tr>';
                        }
                        if (count($reqs) != 0) {
                            echo '<p id="journee">Vous avez recherché des horaires de ' . "$start_search à $fin_search" . '</p>';
